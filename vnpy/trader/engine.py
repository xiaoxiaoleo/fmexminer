...
class MainEngine:
    ...
    def get_local_order_manager(self, gateway_name: str):
        """.
        """
        gateway = self.get_gateway(gateway_name)
        if gateway:
            return gateway.order_manager
        else:
            return ""
...
class LogEngine(BaseEngine):
    ...
    def register_event(self):
        ...
        #self.event_engine.register(EVENT_ALGO_LOG, self.process_algo_log_event)
    ...
    def process_algo_log_event(self, event: Event):
        """
        Output log event data with logging function.
        """
        self.logger.log(20, event.data)
...
class OmsEngine(BaseEngine):
    ...
    def register_event(self):
        ...
        self.event_engine.register(EVENT_ORDERS, self.process_orders_event)
        self.event_engine.register(EVENT_EMPTY_OPEN_ORDER, self.process_empty_open_order_event)
    ...
    def process_order_event(self, event: Event):
        ...
        if not self.orders.get(order.vt_orderid, None):
    ...
    def process_orders_event(self, event: Event):
        """"""
        orders = event.data
        self.orders = orders
            
    def process_empty_open_order_event(self, event: Event):
        self.active_orders = {}
        self.orders = {}
